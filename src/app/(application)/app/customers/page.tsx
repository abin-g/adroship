...
import { MdSecurity, MdOutlineFileUpload } from "react-icons/md";
                ...
                <table className="w-full text-sm text-left text-gray-700 bg-white ">
                    <thead className="bg-gray-100 text-gray-700 text-xs uppercase tracking-wide border-b border-gray-200">
                        <tr>
                            ...
                            <th className="px-6 py-3 font-semibold whitespace-nowrap">
                                <div className="flex items-center gap-2">
                                    <MdSecurity className="text-green-600" /> KYC Status
                                </div>
                            </th>
                            ...
                            >
                                ...
                                <td className="px-6 py-4">
                                    <span className="flex items-center gap-2">
                                        <span
                                            className={`w-2.5 h-2.5 rounded-full ${user.status === "Active"
                                                ? "bg-green-500"
